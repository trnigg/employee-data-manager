...
class Prompts {
    ...
    async updateChoiceArrays() {
        ...
        try {
            ...
            this.addEmployee[3].choices = [...employeeArray, 'NONE']; // added NONE to choices for newEmployeeManager by creating new array spreading all employees and NONE
            ...
            this.updateEmployeeManager[1].choices = employeeArray; // Update choices for updatedEmployeesmanager
            this.deleteEmployee.choices = employeeArray;
            this.viewEmployeesByManager.choices = managerArray;
